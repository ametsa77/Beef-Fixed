                ...
                if (m_version >= 11)
                {
                    ...
                    if (m_version >= 12)
                    {
                        ...
                        if (m_version >= 13)
                        {
                            ...
                            if (m_version >= 14) 
                            {
                                memcpy(&item.unknown_v14, m_data + pos, 4);
                                pos += 4;

                                if (m_version >= 15)
                                {
                                    memcpy(&item.CanPlayerSit, m_data + pos, 1);
                                    pos += 1;
                                    memcpy(&item.SitOffsetX, m_data + pos, 4);
                                    pos += 4;
                                    memcpy(&item.SitOffsetY, m_data + pos, 4);
                                    pos += 4;
                                    memcpy(&item.SitOverX, m_data + pos, 4);
                                    pos += 4;
                                    memcpy(&item.SitOverY, m_data + pos, 4);
                                    pos += 4;
                                    memcpy(&item.SitOverOffX, m_data + pos, 4);
                                    pos += 4;
                                    memcpy(&item.SitOverOffY, m_data + pos, 4);
                                    pos += 4;
